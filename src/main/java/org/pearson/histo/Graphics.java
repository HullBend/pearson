 ...
 * into Java2D coordinates based on suitable projection method.
 */
final class Graphics {
    ...
    /**
     * Draw a string with given reference point and rotation angle. (0.5, 0.5) is
     * center, (0, 0) is lower left, (0, 1) is upper left, etc. The angle of
     * rotation is in radians. The coordinates are logical coordinates.
     */
    void drawText(String label, double[] coord, double horizontalReference, double verticalReference, double rotation) {
    ...
    /**
     * Draw a string with given reference point and rotation angle. (0.5, 0.5) is
     * center, (0, 0) is lower left, (1, 0) is upper left, etc. The angle of
     * rotation is in radians. The logical are proportional to the base coordinates.
     */
    void drawTextBaseRatio(String label, double[] coord, double horizontalReference, double verticalReference,
            double rotation) {
     ...
     * basic alpha compositing rules for combining source and destination colors to
     * achieve blending and transparency effects with graphics and images.
     *
